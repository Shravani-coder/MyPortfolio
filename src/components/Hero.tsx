...
const Hero = () => {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Shravani-coder', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/shravani-wange-694b98292/', label: 'LinkedIn' },
    { icon: Mail, href: 'mailto:shravaniwange7@gmail.com', label: 'Email' },
  ];

  const codingPlatforms = [
    { name: 'LeetCode', img: '/assets/img/leetcode.png', href: 'https://leetcode.com/u/ShravaniWange/' },
    { name: 'Codeforces', img: '/assets/img/codeforces.png', href: 'https://codeforces.com/profile/R_1725' },
    { name: 'CodeChef', img: '/assets/img/codechef.jpeg', href: 'https://www.codechef.com/users/fire_codess12' },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4 text-gray-900 tracking-tight">
              Shravani <span className="text-blue-600">Wange</span>
            </h1>
