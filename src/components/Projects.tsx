...
const Projects = () => {
  ...
  const projects = [
   ...
   {
  title: 'TaxSavvy',
  subtitle: 'Tax Simplification & Planning Platform',
  description:
    'A comprehensive full-stack tax filing application that streamlines financial planning through automated regime comparisons and data-driven insights.',
  details: [
    'Launched a full-stack platform used for seamless tax filing and personalized financial planning',
    'Achieved a 25% boost in filing accuracy via an automated engine that compares tax regimes and recommends deductions',
    'Developed interactive visualization dashboards using Chart.js and D3.js to track and project tax savings',
    'Engineered multi-format export functionality (CSV, PDF) and built robust REST APIs for data management',
  ],
  tech: ['React', 'Node.js', 'Express', 'MySQL/MongoDB', 'Chart.js', 'D3.js', 'REST APIs'],
  image: '/assets/img/projects/taxsavvy.png',
  links: {
    repo: '#',
  },
},
    ...
    // },
    {
  title: 'OutpassTracker',
  subtitle: 'Automated Outpass Management System',
  description:
    'A streamlined digital solution for managing student leave requests, replacing manual logbooks with automated workflows and real-time tracking.',
  details: [
    'Implemented a role-based approval system for seamless request flow between students and wardens',
    'Developed real-time tracking dashboards to improve transparency and monitor student movement',
    'Integrated automated email notifications (Nodemailer) and self-service password recovery',
    'Reduced manual logbook entry by 65% and improved request turnaround speed by 40%',
  ],
  tech: ['React', 'Node.js', 'Express', 'MongoDB', 'REST APIs'],
  image: '/assets/img/projects/outpass_ui.jpeg', // Replace with your actual image path
  links: {
    repo: '#', // Replace with your actual repo link
  },
},
    {
      title: 'MyPortfolio',
